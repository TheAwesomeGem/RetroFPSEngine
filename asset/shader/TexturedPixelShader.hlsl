...
// =============== Variables ===============
static const float4 AMBIENT_LIGHT_COLOR = float4(0.01F, 0.01F, 0.01F, 1.0F);
static const float4 DIRECTIONAL_LIGHT_COLOR = float4(1.1F, 1.04F, 1.0F, 1.0F);
...
float4 main(PsIn input): SV_Target
{
    ...
    float4 diffuse_color = crate_tex.Sample(basic_sampler, input.tex_coord);
